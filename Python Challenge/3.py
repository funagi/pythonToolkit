...
sin = '''kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
for i in range(3,n-3):
    ...
    r=sin[i+1:i+4];
    r2=sin[i+1:i+5];
    if((l.upper()==l)and(r.upper()==r)and(sin[i].lower()==sin[i])):
        if((l2.upper()!=l2)and(r2.upper()!=r2)):
            sout += sin[i]
print sout
print len(sout)